...
function init()
{
    ...
    gl.bufferData(gl.ARRAY_BUFFER, flatten(positionsP), gl.STATIC_DRAW);
    var ppositionLoc = gl.getAttribLocation(program, "pPosition");
    ...
    gl.bufferData(gl.ARRAY_BUFFER, flatten(positionsL), gl.STATIC_DRAW);
    var lpositionLoc = gl.getAttribLocation(program, "lPosition");
    gl.vertexAttribPointer(lpositionLoc, 4, gl.FLOAT, false, 0, 0);
